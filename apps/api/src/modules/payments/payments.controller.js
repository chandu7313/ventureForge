...
var PaymentsController = /** @class */ (function () {
    ...
    PaymentsController.prototype.createOrder = function (userId, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.paymentsService.createOrder(userId, data.amount)];
            });
        });
    };
    PaymentsController.prototype.verifyPayment = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var isValid;
            return __generator(this, function (_a) {
                isValid = this.paymentsService.verifySignature(data.orderId, data.paymentId, data.signature);
                if (!isValid)
    ...
    PaymentsController.prototype.webhook = function (body, signature) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.paymentsService.handleWebhook(body, signature)];
            });
        });
    };
    __decorate([
