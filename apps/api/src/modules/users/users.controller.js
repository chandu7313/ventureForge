...
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.getMe = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersService.getCurrentUser(userId)];
            });
        });
    };
    UsersController.prototype.updateProfile = function (userId, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersService.updateProfile(userId, data)];
            });
        });
    };
    __decorate([
        (0, common_1.Get)('me'),
        (0, swagger_1.ApiOperation)({ summary: 'Get current user profile and plan' }),
