...
var IdeasService = /** @class */ (function () {
    function IdeasService(prisma) {
        this.prisma = prisma;
    }
    IdeasService.prototype.createIdea = function (userId, data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.prisma.idea.create({
                                data: __assign(__assign({}, data), { userId: user.id }),
                            })];
                }
            });
        });
