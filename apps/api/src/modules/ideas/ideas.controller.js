...
exports.IdeasController = exports.CreateIdeaDto = void 0;
var common_1 = require("@nestjs/common");
var swagger_1 = require("@nestjs/swagger");
var ideas_service_1 = require("./ideas.service");
...
var CreateIdeaDto = /** @class */ (function () {
    function CreateIdeaDto() {
    }
    __decorate([
        (0, class_validator_1.IsString)(),
        __metadata("design:type", String)
    ], CreateIdeaDto.prototype, "name", void 0);
    __decorate([
        (0, class_validator_1.IsString)(),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        (0, class_validator_1.IsOptional)(),
        __metadata("design:type", String)
    ], CreateIdeaDto.prototype, "monetization", void 0);
    return CreateIdeaDto;
}());
exports.CreateIdeaDto = CreateIdeaDto;
var IdeasController = /** @class */ (function () {
    function IdeasController(ideasService) {
        this.ideasService = ideasService;
    }
    IdeasController.prototype.createIdea = function (userId, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.ideasService.createIdea(userId, data)];
            });
        });
    };
    __decorate([
        (0, common_1.Post)(),
        (0, swagger_1.ApiOperation)({ summary: 'Create a new startup idea' }),
        __param(0, (0, current_user_decorator_1.CurrentUser)()),
        __param(1, (0, common_1.Body)()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String, CreateIdeaDto]),
    ...
    IdeasController = __decorate([
        ...
        (0, common_1.Controller)('api/v1/ideas'),
